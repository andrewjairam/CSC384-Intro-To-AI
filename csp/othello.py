...
def read_from_file(filename):
    ...
    f.close()
    row_cnsts = [int(x) for x in board.pop(0)]
    col_cnsts = [int(x) for x in board.pop(0)]
    ship_nmbrs = [int(x) for x in board.pop(0)]
...
if __name__ == '__main__':
    ...
    board, row_nums, col_nums, ship_cnsts = read_from_file(args.inputfile)
    # board = [ ['.', 'S', '.', '<', 'M', '>'],
    #           ['.', '.', '.', '.', '.', '.'],
    #           ['S', '.', '.', '0', '0', '0'],
    #           ['.', '.', '.', '.', '.', '.'],
    #           ['.', '<', '>', '.', '.', '.'],
    #           ['.', '.', '.', '.', '.', '0'] ]s
    # col_nums = [1, 2, 1, 1, 2, 3]
    # row_nums = [4, 0, 3, 0, 2, 1]
    # print(board)
    # print(row_nums)
    # print(col_nums)
    # print(ship_cnsts)
    ...
    #           ['0', '0', '0', '0', 'v', '0', '0', '0'],
    #           ['0', '0', '0', '0', '0', '0', 'v', '0'],]
    # row_nums = [4,1,5,0,4,1,2,2]
    # col_nums = [0,3,2,2,4,2,4,2]
    # ship_cnsts = [3,3,2,1]
    ...
    solution_here = find_valid_solution(ship_cnsts)
    write_solution(solution_here)